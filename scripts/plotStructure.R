...
out_all <- paste("structure_plot_maxK",maxK,".pdf",sep="")
#plot selected K with inidividuals in groups
allk <- plotQ(slist[1:maxK],imgoutput="join",returnplot=T,exportplot=F, basesize=11,
...
for (i in 1:maxK) {
        single_out <- paste("structure_plot_K",i,".pdf",sep="");
